...
const BooksPage = () => {
  ...
  // Pestañas: envios vs configuracion (solo admin)
          ...
          <div className="max-w-[1920px] mx-auto px-6 py-4 relative z-10">
            <div className="flex items-center justify-between gap-4 flex-wrap">
              ...
              <div className="flex items-center gap-3">
                {isAdmin && (
                  <div className="flex items-center rounded-md border border-white/25 overflow-hidden">
                    <button
                      type="button"
                      onClick={() => setTab('sends')}
                      className={cn(
                        "px-3 py-2 text-sm font-medium transition-colors",
                        tab === 'sends' ? "bg-white text-primary" : "text-white/80 hover:bg-white/10"
                      )}
                    >
                      Envíos
                    </button>
                    <button
                      ...
                      className={cn(
                        "px-3 py-2 text-sm font-medium transition-colors border-l border-white/25",
                        tab === 'settings' ? "bg-white text-primary" : "text-white/80 hover:bg-white/10"
                      )}
                    >
...
// Panel de configuracion SMTP, visible solo para admin.
const BooksSettingsPanel = () => {
